            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <strong>{{$title}}</strong>
                        <a href="{{route('clients.index')}}" class="btn btn-danger btn-sm fr">Voltar</a>
                    </div>
                        ...
                        <form method="POST" action="{{route('clients.update',$user->id)}}" enctype='multipart/form-data'>
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    ...
                                    <input type="text" id="cpf" class="form-control @if($errors->any() && empty(old('login'))) is-invalid @endif" name="login" value="{{old('login',$user->login)}}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
